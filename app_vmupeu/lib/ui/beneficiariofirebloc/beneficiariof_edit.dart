...
class BeneficiarioFormFireEdit extends StatefulWidget {
  BeneficiarioModel modelP;

  BeneficiarioFormFireEdit({this.modelP}) : super();
...
class _BeneficiarioFormEditState extends State<BeneficiarioFormFireEdit> {
  String _dni;
  String _nombre;
  String _telefono;
  int _edad;
