...
class BeneficiarioFireForm extends StatefulWidget {
  @override
  _BeneficiarioFormState createState() => _BeneficiarioFormState();
}
...
class _BeneficiarioFormState extends State<BeneficiarioFireForm> {
  String _dni;
  String _nombre;
  String _telefono;
  int _edad;
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              ...
                              if (_formKey.currentState.validate()) {
                                ...
                                mp.genero = _genero;
                                BlocProvider.of<BeneficiarioBloc>(context).add(CreateBeneficiarioEvent(beneficiario: mp));
