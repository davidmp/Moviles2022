...
import 'package:app_vmupeu/repository/BeneficiarioRepository.dart';
import 'package:app_vmupeu/ui/beneficiariobloc/beneficiariob_edit.dart';
import 'package:app_vmupeu/ui/beneficiariobloc/beneficiariob_form.dart';
import 'package:flutter/material.dart';
import 'package:app_vmupeu/modelo/beneficiario_model.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:intl/intl.dart';

class MainBeneficiario extends StatelessWidget {
  @override
...
class BeneficiarioUI extends StatefulWidget {
  @override
  _BeneficiarioUIState createState() => _BeneficiarioUIState();
}

class _BeneficiarioUIState extends State<BeneficiarioUI> {
//ApiCovid apiService;
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => BeneficiarioForm()),
                ).then(onGoBack);
              },
                              ...
                              IconButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => BeneficiarioFormEdit(
